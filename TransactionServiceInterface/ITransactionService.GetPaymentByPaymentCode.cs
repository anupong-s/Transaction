...
{
    [DataContract]
    public class GetPaymentCodeRequest
    {
        [DataMember]
    ...
    [DataContract]
    public class GetPaymentCodeResponse : AbstractResponse
    {
        /// <summary>
        ...
        /// </summary>
        [DataMember]
        public PaymentItemResponse[] PaymentItems { get; set; }
    }
    ...
    {
        [OperationContract]
        GetPaymentCodeResponse GetPaymentByPaymentCode(GetPaymentCodeRequest req);
    }
}
